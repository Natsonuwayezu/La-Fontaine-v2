    ...
    if (container) container.innerHTML = `
      <div class="module-wrap">
        <div class="mod-topbar">
          <div class="skeleton skeleton-line w-30" style="height:26px;border-radius:8px;"></div>
          <div style="margin-left:auto;display:flex;gap:8px;">
            <div class="skeleton skeleton-line w-100" style="height:32px;width:80px;border-radius:8px;"></div>
            <div class="skeleton skeleton-line w-100" style="height:32px;width:80px;border-radius:8px;"></div>
          </div>
        </div>
        <div class="skeleton-card">
          <div class="skeleton skeleton-line w-70" style="margin-bottom:10px;"></div>
