...
window.renderAttendanceReports = async (container, params = {}) => {
    ...
    if (container) {
        ...
        _ns.innerHTML = `<button class="btn btn-ghost btn-sm" onclick="navigateTo('attendance-entry')"><i class="fa-solid fa-pen"></i> Enter Attendance</button>         <button class="btn btn-ghost btn-sm" onclick="navigateTo('attendance-summary')"><i class="fa-solid fa-list"></i> Summary</button>`;
