        ...
        <div class="dash-card">
            ...
            <div class="dash-card-body">
                <div class="alert alert-info" style="font-size:0.85rem;">
                    ...
                    <br><small style="color:var(--text-muted);">Student will be enrolled in the current academic year.</small>
                </div>
...
async function submitEnroll() {
    ...
    try {
        ...
        const student = await insert('students', {
            ...
            student_code: code,
            academic_year_id: currentYear.id,  // ← IMPORTANT: Store current year
            gender: gender || null,
            date_of_birth: dob,
        ...
        // If the student_class_history table exists, record the initial class
        try {
